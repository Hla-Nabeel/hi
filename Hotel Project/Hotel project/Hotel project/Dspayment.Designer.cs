...
namespace Hotel_project {
    ...
    public partial class Dspayment : global::System.Data.DataSet {
        ...
        public partial class PaymentDataTable : global::System.Data.TypedTableBase<PaymentRow> {
            ...
            private global::System.Data.DataColumn columnpayment_cost;
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public global::System.Data.DataColumn payment_costColumn {
                get {
                    return this.columnpayment_cost;
                }
            }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PaymentRow AddPaymentRow(string payment_cost, int booking_id) {
            ...
            internal void InitVars() {
                ...
                this.columnpayment_cost = base.Columns["payment_cost"];
            ...
            private void InitClass() {
                ...
                this.columnpayment_cost = new global::System.Data.DataColumn("payment_cost", typeof(string), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnpayment_cost);
                ...
                this.columnpayment_cost.AllowDBNull = false;
                this.columnpayment_cost.MaxLength = 50;
        ...
        public partial class PaymentRow : global::System.Data.DataRow {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public string payment_cost {
                get {
                    return ((string)(this[this.tablePayment.payment_costColumn]));
                }
                set {
                    this[this.tablePayment.payment_costColumn] = value;
                }
            }
...
namespace Hotel_project.DspaymentTableAdapters {
    ...
    public partial class PaymentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("payment_cost", "payment_cost");
            tableMapping.ColumnMappings.Add("booking_id", "booking_id");
            this._adapter.TableMappings.Add(tableMapping);
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Payment] WHERE (([payment_id] = @Original_payment_id) AND ([payment_" +
                "cost] = @Original_payment_cost) AND ([booking_id] = @Original_booking_id))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_payment_cost", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "payment_cost", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Payment] ([payment_cost], [booking_id]) VALUES (@payment_cost, @book" +
                "ing_id);\r\nSELECT payment_id, payment_cost, booking_id FROM Payment WHERE (paymen" +
                "t_id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@payment_cost", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "payment_cost", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Payment] SET [payment_cost] = @payment_cost, [booking_id] = @booking_id WHERE (([payment_id] = @Original_payment_id) AND ([payment_cost] = @Original_payment_cost) AND ([booking_id] = @Original_booking_id));
SELECT payment_id, payment_cost, booking_id FROM Payment WHERE (payment_id = @payment_id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@payment_cost", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "payment_cost", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_payment_cost", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "payment_cost", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Hotel_project.Properties.Settings.Default.HotelFConnectionString;
        }
        ...
        public virtual int Fill(Dspayment.PaymentDataTable dataTable) {
        ...
        public virtual Dspayment.PaymentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Dspayment.PaymentDataTable dataTable = new Dspayment.PaymentDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Dspayment.PaymentDataTable dataTable) {
        ...
        public virtual int Delete(int Original_payment_id, string Original_payment_cost, int Original_booking_id) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_payment_id));
            if ((Original_payment_cost == null)) {
                throw new global::System.ArgumentNullException("Original_payment_cost");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[1].Value = ((string)(Original_payment_cost));
            }
        ...
        public virtual int Insert(string payment_cost, int booking_id) {
            if ((payment_cost == null)) {
                throw new global::System.ArgumentNullException("payment_cost");
            }
            else {
                this.Adapter.InsertCommand.Parameters[0].Value = ((string)(payment_cost));
            }
        ...
        public virtual int Update(string payment_cost, int booking_id, int Original_payment_id, string Original_payment_cost, int Original_booking_id, int payment_id) {
            if ((payment_cost == null)) {
                throw new global::System.ArgumentNullException("payment_cost");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[0].Value = ((string)(payment_cost));
            }
            ...
            if ((Original_payment_cost == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(Original_payment_cost));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string payment_cost, int booking_id, int Original_payment_id, string Original_payment_cost, int Original_booking_id) {
            return this.Update(payment_cost, booking_id, Original_payment_id, Original_payment_cost, Original_booking_id, Original_payment_id);
        }
    }
